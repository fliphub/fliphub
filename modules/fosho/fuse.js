...
function throws(msg, arg2, arg3) {
  if (arg2) console.log(arg2, arg3)
  throw new Error()
}
class ShouldInstance {
  constructor(obj) {
    ...
    // alias
    this.aintGotString = this.aintHasString.bind(this)
    this.aintGotStr = this.aintHasString.bind(this)
    this.aintNoStr = (str) => {
      if (typeof str === 'string') throws(`${str} was a string!`)
      return true
    }
    this.aintNoStrang = this.aintNoStr
    this.eq = this.equal.bind(this)
    this.equals = this.equal.bind(this)
    this.preMuch = this.equal.bind(this)
    this.deepEquals = this.deepEqual.bind(this)
  }

  // eq(o) { return this.equal(o) }
  // equals(o) { return this.equal(o) }
  // preMuch(o) { return this.equal(o) }
  // deepEquals(o) { return this.deepEqual(o) }
  // eq(o) { if (this.obj !== o) throws(`!= `, this.obj, o); return true }
  // equals(o) { if (this.obj !== o) throws(`!= `, this.obj, o); return true }
  // preMuch(o) { if (this.obj !== o) throw new Error('not equal'); return true }
  // deepEquals(o) { return this.deepEqual(o) }
  aintHasString(str) {
    if (this.obj.includes(str))
      throw new Error(`Expected ${this.obj} not include ${str}`)
    return true
  }
