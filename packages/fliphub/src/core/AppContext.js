// const {BundlesContext} = require('../hubs/BundlerHub/BundleContext')
// const BuilderContext = require('../hubs/BuilderHub/BuilderContext')
...
class AppContext {
  constructor(app, box) {
    ...
    this.box = box
    this.app = app
    // this.builder = new BuilderContext({helpers: box.helpers, context: this})
    this.setupEvents()
