...
var UpdatedPackagesCollector = function () {
  ...
  _createClass(UpdatedPackagesCollector, [{
    ...
    value: function collectUpdatedPackages() {
      ...
      if (hasTags) {
        var tag = _GitUtilities2.default.getLastTag();
        _logger2.default.info("Comparing with: " + tag);
      } else {
        _logger2.default.info("No tags found! Comparing with initial commit.");
      }
      ...
      if (this.flags.canary) {
        ...
        commits = _GitUtilities2.default.describeTag(_GitUtilities2.default.getLastTaggedCommitInBranch());
      }
    ...
    value: function hasDiffSinceThatIsntIgnored(pkg, commits) {
      ...
      if (this.flags.ignore) {
        changedFiles = changedFiles.filter(function (file) {
          return !(0, _find2.default)(_this5.flags.ignore, function (pattern) {
